...
public class PersonaDaoImpl implements PersonaDao {
	...
	public Persona findPersonaById(long idPersona) {
		...
		// BeanPropertyRowMapper.newInstance(Persona.class); // return
		// jdbcTemplate.queryForObject(SQL_SELECT_PERSONA_BY_ID,
		// personaRowMapper,
		// idPersona);
	}
	...
	public int contadorPersonas() {
		...
		// Esta es otra opcion si no tuvieramos jdbcTemplate return
